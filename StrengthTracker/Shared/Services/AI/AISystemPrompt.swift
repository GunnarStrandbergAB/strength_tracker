...
public enum AISystemPrompt {
    ...
    public static func build(weightUnit: WeightUnit, memories: [String] = [], date: Date = Date()) -> String {
        ...
        their exact name.
        - Use save_memory for lasting facts the user shares (name, preferences, injuries, goals) and \
        forget_memory when asked to forget or when a saved fact is outdated. Never store transient \
        workout details as memories.
