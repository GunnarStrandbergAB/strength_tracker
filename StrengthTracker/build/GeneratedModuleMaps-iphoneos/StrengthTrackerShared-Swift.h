...
#ifndef STRENGTHTRACKERSHARED_SWIFT_H
#define STRENGTHTRACKERSHARED_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="StrengthTrackerShared",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
# pragma pop_macro("any")
#endif

#if defined(__OBJC__)

SWIFT_CLASS("_TtC21StrengthTrackerShared19ConnectivityManager")
...
@class WCSession;
@class NSString;
@interface ConnectivityManager (SWIFT_EXTENSION(StrengthTrackerShared)) <WCSessionDelegate>
